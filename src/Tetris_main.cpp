...
bool loadMedia()
{
	...
	if ( !welcomeTexture.load( "media/welcome.png" ) )
	{
		printf( "Failed to load welcome.bmp.\n" );
		return false;
	}
...
int main ( int argc, char* argv[] )
{
	...
	while ( !quit )
	{
		while ( SDL_PollEvent( &e ) )
		{
			...
			if ( e.type == SDL_KEYDOWN && waitforstart )
			{
				waitforstart = false;
			}
